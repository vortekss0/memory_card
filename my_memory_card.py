...
questions_list.append(
        ...
        Question('2+2*2', '6', '8', '4', '12'))

questions_list.append(

        Question('Кто президент России в настоящее время', 'Путин', 'Медведев', 'Гитлер', 'Наполеон'))

questions_list.append(

        Question('Брат Саске в аниме Наруто', 'Итачи', 'Сакура', 'Наруто', 'Орочимару'))

questions_list.append(

        Question('Какая игра появилась раньше', 'CS:GO', 'Valorant', 'Fortnite', 'Call of Duty Warzone'))

questions_list.append(

        Question('Сколько игроков может быть в лобби в оригинальной версии Amon Us ', '10', '8', '9', '12'))

questions_list.append(

        Question('Сколько ног у лошади', '4', '3', '5', '17'))

questions_list.append(

        Question('Сколько глаз у человека', '2', '1', '3', '5'))

questions_list.append(

        Question('Какой из главных героев умер в фильме Мстители:Финал', 'Железный человек ', 'Капитан Америка', 'Тор', 'Человек-Паук'))

questions_list.append(

        Question('Сколько цветов на флаге России', '3','2', '4', '11'))

questions_list.append(

        Question('Версия Windows которая стоит на ноутбуках в классе', '10','8', '7', '1'))

questions_list.append(

        Question('Со скольки лет можно получить паспорт', '14','0', '18', '1'))
